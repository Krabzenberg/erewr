...
namespace Extensa\Careers\Block\Adminhtml\Subscribers;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Extensa_Careers::subscribers')) {
    ...
    {
        if ($this->_coreRegistry->registry('subscriber_item')->getId()) {
            return __(
                "Edit Subscriber '%1'",
                $this->escapeHtml($this->_coreRegistry->registry('subscriber_item')->getId())
            );
        } else {
